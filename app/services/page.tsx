  ...
  const services = [
    {
      ...
      description: 'We create responsive, user-friendly websites that convert visitors into customers.',
    ...
    },
    {
      ...
      description: 'Engage with your audience and grow your brand on social media platforms.',
    ...
    },
    {
      ...
      features: ['Google Ads', 'Bing Ads', 'Ad Copywriting', 'Conversion Tracking'],
    ...
    },
    {
      ...
      description: 'Nurture leads and build customer loyalty through effective email campaigns.',
      features: ['Newsletter Design', 'Automation Sequences', 'A/B Testing', 'Performance Analytics'],
      image: '/images/Email-markerting.png',
    ...
    <div className={styles.servicesPage}>
      <div className="container">
        ...
        <div className={styles.mobileServicesDropdown}>
          ...
          >
            Browse All Services
            <span className={`${styles.dropdownArrow} ${showMobileDropdown ? styles.open : ''}`}>
              ▼
            </span>
          </button>
        ...
        <div className={styles.ctaSection}>
          ...
          <Link href="/GetStarted" className="btn">Get Started</Link>
        </div>
      </div>
    </div>
